...
class Disasm:
	def __init__(self):
		...
		self.instructions = (
			...
			((0xf, 6, 8, 0xe), 'POP', 'PSW, PC'),
			((0xf, 7, 8, 0xe), 'POP', 'EA, PSW, PC'),
			((0xf, 8, 8, 0xe), 'POP', 'LR'),
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description = 'PyU8disas - nX-U8 disassembler. Outputs assembly format.', epilog = '(c) 2023-2024 GamingWithEvets Inc.\nLicensed under the MIT license', formatter_class=argparse.RawTextHelpFormatter, allow_abbrev = False)
